...
import (
	...
	"github.com/ruckstack/ruckstack/common/files"
	"io"
	"io/ioutil"
	"net"
	"os"
...
func Install(packageConfig *common.PackageConfig, installerArgs *InstallerArgs, zipReader *zip.ReadCloser) error {

	fmt.Printf("%s %s Installer\n", packageConfig.Name, packageConfig.Version)
	fmt.Println("---------------------------------------------")

	systemConfig := new(common.SystemConfig)
	localConfig := new(common.LocalConfig)
	...
	common.SetPackageConfig(packageConfig)
	common.SetSystemConfig(systemConfig)
	common.SetLocalConfig(localConfig)
...
func getInstallPath(ui *bufio.Scanner, packageConfig *common.PackageConfig, installerArgs *InstallerArgs) string {
...
func getJoinToken(ui *bufio.Scanner, packageConfig *common.PackageConfig, installerArgs *InstallerArgs) (*common.AddNodeToken, error) {
	addNodeToken := &common.AddNodeToken{}
