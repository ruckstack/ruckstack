...
func TestNewProject_example(t *testing.T) {
	...
	outDir := environment.TempPath("test_new_example_project")
...
func TestNewProject_starter(t *testing.T) {
	outDir := environment.TempPath("test_new_starter_project")
...
func TestNewProject_invalid(t *testing.T) {
	outDir := environment.TempPath("test_new_invalid_project")
