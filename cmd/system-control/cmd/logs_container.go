...
var logsContainerCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		logs.ShowContainerLogs(systemService, args[0], followLogs, previousLogs, logsSince)
	},
}
...
func init() {
	...
	logsContainerCmd.Flags().BoolVar(&followLogs, "follow", false, "Continue to output log messages")
